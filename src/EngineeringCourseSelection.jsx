    ...
    >
      ...
      <main className="max-w-6xl mx-auto px-6 pt-4">
        ...
        <section className="mx-auto max-w-4xl">
          <a
            href="https://cle.hkust.edu.hk/courses/lang1407"
            target="_blank"
            rel="noopener noreferrer"
            className="block rounded-[32px] border border-amber-200 bg-gradient-to-b from-orange-50 to-amber-100 p-10 text-left shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
          >
            <h3 className="mb-4 text-4xl font-semibold">LANG 1407</h3>
