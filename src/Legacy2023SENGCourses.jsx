...
export default function Legacy2023SENGCourses() {
  ...
  const isAISFlow = location.pathname === "/english/2023/ais/lang2030";
  const previousPage =
      ...
      <PageNavBar onBack={() => {
            ...
            setTimeout(() => {
              navigate(previousPage, {
                state: isAISFlow
                  ? { direction: "down", affiliation: "SENG", previousPage: "/english/2023/ais" }
                  : { direction: "down" },
              });
            }, 300);
          }} />
          ...
          <button
            onClick={() => {
              ...
              setTimeout(() => {
                navigate(
                  isAISFlow
                    ? "/english/2023/ais/isd-question"
                    : "/english/2023/seng/advanced-communication",
                  {
                    state: {
                      direction: "up",
                      previousPage: location.pathname,
                      ...(isAISFlow ? { affiliation: "SENG" } : {}),
                    },
                  },
                );
              }, 300);
