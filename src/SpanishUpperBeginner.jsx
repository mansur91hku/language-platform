...
export default function SpanishUpperBeginner() {
  ...
  return (
    ...
    >
      <PageNavBar onBack={() => { setExitDirection("down"); setTimeout(() => navigate("/third-languages/spanish", { state: { direction: "down" } }), 300); }} />

      <main className="max-w-6xl mx-auto px-6 pt-4">
        <section className="text-center py-10">
          <h2 className="text-5xl md:text-7xl font-semibold tracking-tight mb-4">Spanish</h2>
          <p className="text-xl text-gray-600">Upper-Beginner Level</p>
        </section>

        <section className="flex justify-center">
          <a
            href="https://cle.hkust.edu.hk/courses/lang2330"
            target="_blank"
          ...
          >
            <h4 className="text-3xl font-semibold mb-3">LANG 2330</h4>
            <p className="text-gray-700 mb-4">Spanish Language and Culture for Beginners II</p>
