...
import { isYear2026 } from "./utils/englishYear";
    ...
    >
      ...
      <main className="max-w-6xl mx-auto px-6 pt-4">
        ...
        <section className="mx-auto max-w-4xl">
          <a
            href="https://cle.hkust.edu.hk/courses/lang1408"
            target="_blank"
            rel="noopener noreferrer"
            className="block rounded-[32px] border border-violet-200 bg-gradient-to-b from-purple-50 to-violet-100 p-10 text-left shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
          >
            <h3 className="mb-4 text-4xl font-semibold">LANG 1408</h3>
            <p className="mb-4 text-lg text-gray-700">
              Academic English for Humanities and Social Science Studies
            </p>
            <span className="font-medium text-violet-700">View Course Details</span>
          </a>
        </section>
              ...
              setTimeout(() => {
                const nextRoute =
                  (year === "2025" || year === "2024") && pathway === "pathway1"
                    ? `/english/${year}/${pathway}/humanities/advanced-communication`
                    : `/english/${year}/${pathway}/humanities/other-courses`;
