...
export default function JapaneseUpperBeginner() {
  ...
  return (
    ...
    >
      <PageNavBar onBack={() => { setExitDirection("down"); setTimeout(() => navigate("/third-languages/japanese", { state: { direction: "down" } }), 300); }} />
