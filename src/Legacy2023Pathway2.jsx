...
export default function Legacy2023Pathway2() {
  ...
  useEffect(() => {
    sessionStorage.setItem("legacy2023PathwayOrigin", "pathway2");
  }, []);
      ...
      <main className="max-w-6xl mx-auto px-6 pt-4">
        ...
        <section className="text-center py-10">
          ...
          <p className="text-xl text-gray-600">
            Required Common Core course (3 credits + 3 credits transferred on admission)
          </p>
        </section>
        ...
        <section className="max-w-4xl mx-auto">
          <a
            ...
            "
          >
            <h3 className="text-4xl font-semibold mb-4">LANG 1403 / 1404</h3>
            <p className="text-gray-700 text-lg mb-4">
              English for Professional Communication (3 credits), with 3 other
              credits transferred on admission
            </p>
