    ...
    >
      ...
      <main className="max-w-6xl mx-auto px-6 pt-4">
        ...
        <section className="max-w-4xl mx-auto">
          <a
            href="https://cle.hkust.edu.hk/courses/lang2070"
            target="_blank"
            rel="noopener noreferrer"
            className="
              block bg-gradient-to-b from-purple-50 to-violet-100
              border border-violet-200 rounded-[32px] p-10 text-left
          ...
          >
            ...
            <p className="text-gray-700 text-lg mb-4">
              English Communication for Humanities and Social Science Studies I (3 credits)
            </p>
            ...
            onClick={() => {
              ...
              setTimeout(() => {
                navigate("/english/pathway1/science/advanced-communication", {
                  state: {
                    direction: "up",
                    previousPage: "/english/2023/shss",
                  },
                });
              }, 300);
            }}
