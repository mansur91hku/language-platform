...
function SingleExtraCourse({ courseCode, courseTitle, courseUrl, textColorClass, gradientClass, borderClass }) {
        ...
        <section className="text-center mt-10 pb-16">
          ...
          <button
            onClick={() => {
              setExitDirection("up");
              setTimeout(() => {
                navigate("/english/2023/ssci/advanced-communication", {
...
export function Legacy2023SSCIBTBProg() {
  return (
    <SingleExtraCourse
      courseCode="LABU 2060"
      courseTitle="Effective Communication in Business (3 credits)"
      courseUrl="https://cle.hkust.edu.hk/courses/labu2060"
      gradientClass="from-sky-50 to-blue-100"
      borderClass="border-blue-200"
      textColorClass="text-blue-700"
    />
...
// ─── MAEC: LANG 2062 / LANG 2061 choice ───────────────────────────────────────
        ...
        <section className="text-center mt-10 pb-16">
          ...
          <button
            onClick={() => {
              setExitDirection("up");
              setTimeout(() => {
                navigate("/english/2023/ssci/maec/advanced-communication", {
                  state: {
                    direction: "up",
