...
export default function CantoneseChineseBackground() {
  ...
  return (
    ...
    >
      <div className="fixed top-4 left-4 right-4 flex items-center justify-between z-50 pointer-events-none">
        <button
          onClick={() => { setExitDirection("down"); setTimeout(() => navigate("/third-languages/cantonese", { state: { direction: "down" } }), 300); }}
          className={navBtn}
        >
          Back
        </button>
      ...
      <main className="max-w-6xl mx-auto px-6 pt-4">
        <section className="text-center py-10">
          ...
          <p className="text-xl text-gray-600">Chinese Language Background</p>
        </section>
        ...
        <section className="flex justify-center">
          ...
          >
            ...
            <p className="text-gray-700 mb-4">Cantonese for Chinese Language Background Students I</p>
